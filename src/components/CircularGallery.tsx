// @ts-nocheck — legacy engine-style classes rely on implicit instance fields without TS declarations.
...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    // Increase plane height so images sit closer to canvas edges.
...
class App {
  ...
  createRenderer() {
    ...
    // Ensure the canvas fills the container with no extra whitespace.
